...
2. **Select a defender**
   Picks the player's first available combat unit, skipping the MCV.
   If no suitable unit exists, an LTNK is spawned next to the derrick using `house:SpawnUnit`.
